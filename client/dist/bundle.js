...
(function () {
	...
	*/
	...
	var css_248z$4 = ".tasks {\n  display: flex;\n  justify-content: center;\n  flex-wrap: wrap;\n}\n\n.task {\n  padding: 10px;\n  width: 220px;\n  border-radius: 5px;\n  background-color: white;\n  margin: 10px;\n  border: 1px solid gray;\n  cursor: pointer;\n}\n\n.task-title,\n.task-id {\n  display: block;\n  font-size: 14px;\n  color: #333;\n}\n\n.task-id {\n  text-align: right;\n}\n\n@media screen and (max-width: 640px) {\n  .tasks {\n    height: 76px;\n  }\n  .task {\n    position: absolute;\n  }\n}";
	styleInject(css_248z$4);

	const Tasks = ({
	  tasks
	}) => {
	  const [context, setContext] = react.exports.useContext(Context);
	  ...
	  return /*#__PURE__*/React.createElement("div", {
	    className: "tasks"
	  }, tasks && tasks.length > 0 && tasks.map(task => /*#__PURE__*/React.createElement("div", {
	    key: task.uuid,
	    className: "task",
	    onClick: () => onOpen(task)
	...
	const fetchTasks = async n => {
	  const response = await fetch(`${API_URL}/tasks${n ? '/' + n : ''}`);
	  const data = await response.json();
	  return data.tasks;
	};
	const completeTask = async n => {
	  const response = await fetch(`${API_URL}/tasks/${n}`, {
	    method: 'PUT'
	  });
	  await response.json();
	};

	var css_248z$2 = ".complete-task-overlay {\n  position: fixed;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  top: 0;\n  left: 0;\n  height: 100%;\n  width: 100%;\n  background-color: rgba(0, 0, 0, 0.5);\n}\n\n.complete-task-modal {\n  border-radius: 5px;\n  background-color: white;\n  padding: 10px;\n  width: 300px;\n}\n\n.complete-task-modal .modal-body {\n  color: #333;\n  margin-bottom: 20px;\n}\n\n.complete-task-modal .modal-action {\n  text-align: right;\n}\n\n.complete-task-modal .modal-action button {\n  margin: 0 10px;\n  cursor: pointer;\n}\n\n@media screen and (max-width: 640px) {\n  .complete-task-modal {\n    width: 280px;\n  }\n}";
	...
	const CompleteTask = () => {
	  ...
	  return /*#__PURE__*/ReactDOM.createPortal( /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
	    className: "complete-task-overlay"
	  }, /*#__PURE__*/React.createElement("div", {
	    className: "complete-task-modal"
	  }, /*#__PURE__*/React.createElement("div", {
	    className: "modal-body"
	  }, "Task #", selectedTask.uuid, ", ", selectedTask.title), /*#__PURE__*/React.createElement("div", {
	    className: "modal-action"
	  }, /*#__PURE__*/React.createElement("button", {
	    type: "button",
	    onClick: onComplete
	  }, loading ? 'loading...' : 'Complete'), /*#__PURE__*/React.createElement("button", {
	    type: "button",
	    onClick: onClose
	  }, "Close"))))), document.body);
	};

	var css_248z$1 = ".choose {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  width: 100%;\n  margin-bottom: 40px;\n}\n\n.choose > * {\n  margin: 0 5px;\n}";
	styleInject(css_248z$1);

	const Choose = () => {
	  const [context, setContext] = react.exports.useContext(Context);
	  const [quantity, setQuantity] = react.exports.useState('');
	  ...
	  return /*#__PURE__*/React.createElement("div", {
	    className: "choose"
	  }, /*#__PURE__*/React.createElement("label", null, "Number of tasks: "), /*#__PURE__*/React.createElement("input", {
	    type: "text",
	    value: quantity,
	...
	var css_248z = ".loader-container {\n  display: block;\n  width: 100%;\n}\n\n.loader-container .loader {\n  margin: 0 auto;\n}\n\nh1 {\n  text-align: center;\n}\n";
	styleInject(css_248z);

	const Context = /*#__PURE__*/react.exports.createContext();

	function App() {
	  const [context, setContext] = react.exports.useState({
	    openModal: false,
	    selectedTask: null,
	    tasks: [],
	    fetching: false
	  ...
	  }, /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("h1", null, "Tasks"), /*#__PURE__*/React.createElement(Choose, null), fetching && /*#__PURE__*/React.createElement("div", {
	    className: "loader-container"
	  }, /*#__PURE__*/React.createElement(Loader, null)), !fetching && tasks && tasks.length > 0 && /*#__PURE__*/React.createElement(Tasks, {
	    tasks: tasks
	  }), openModal && /*#__PURE__*/React.createElement(CompleteTask, null)));
	}
